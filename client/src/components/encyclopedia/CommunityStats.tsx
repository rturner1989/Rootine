import type { SpeciesCommunityStats } from '../../types/species'
import Card from '../ui/Card'
import Heading from '../ui/Heading'

export type CommunityStatsProps = {
  community?: SpeciesCommunityStats | null
}
...
export default function CommunityStats({ community }: CommunityStatsProps) {
  ...
  const stats: { label: string; value: number | string | null }[] = [
