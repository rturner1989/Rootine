...
const LIGHT_LABEL: Record<string, string> = Object.fromEntries(
  LIGHT_OPTIONS.map((option) => [option.value, option.label]),
)
...
export default function ActiveChips() {
  ...
  function clearAxis(patch: Partial<typeof filters>) {
