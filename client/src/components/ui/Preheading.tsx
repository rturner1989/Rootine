...
export type PreheadingVariant = keyof typeof VARIANTS

export type PreheadingProps = {
  variant?: PreheadingVariant
  as?: ElementType
  className?: string
  children?: ReactNode
}

export default function Preheading({ variant = 'card', as: Tag = 'div', className = '', children }: PreheadingProps) {
