import type { OnboardingIntent, User } from '../../types/user'
...
// Object.keys() is typed string[] regardless of the source object's key
// type — INTENTS' keys are the closed OnboardingIntent enum, so this is a
// safe narrowing, not a real widening of what INTENT_KEYS can contain.
const INTENT_KEY_LIST = INTENT_KEYS as OnboardingIntent[]
...
export default function IntentCard({ profile }: IntentCardProps) {
