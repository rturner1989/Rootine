...
import type { FilterDraft } from '../../../../src/utils/filterSchema'
...
describe('applyFilters', () => {
  ...
  function commit(draft: FilterDraft, startingQuery = '') {
    const setSearchParams = vi.fn()
    applyFilters(setSearchParams, draft)
    const [updater, options] = setSearchParams.mock.calls[0] as Parameters<SetURLSearchParams>
    return {
      params: (updater as (prev: URLSearchParams) => URLSearchParams)(new URLSearchParams(startingQuery)),
      options,
    }
  }
