...
import type { FilterControlProps } from '../../../src/components/ui/FilterControl'
import FilterControl from '../../../src/components/ui/FilterControl'
import type { FilterDraft, FilterSchema } from '../../../src/utils/filterSchema'
...
const EMPTY: FilterDraft = { kinds: [], petSafe: null }

function renderControl(props: Partial<FilterControlProps> = {}) {
  return render(
    <FilterControl
      schema={SCHEMA}
      filters={EMPTY}
