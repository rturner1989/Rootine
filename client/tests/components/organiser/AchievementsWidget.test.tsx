...
import type { AchievementsResponse } from '../../../src/types/achievement'

// AchievementsWidget's dependency tree (useAchievements) only calls
// `request` — setAccessToken/getAccessToken are never reached from here.
vi.mock(
  '../../../src/api/client',
